...
final List<ProductModel> dummyProducts = [
  ProductModel(
    ...
    description: 'A classic obsidian silk trench coat crafted for modern luxury and timeless elegance.',
  ...
  ProductModel(
    ...
    description: 'Heavyweight organic cotton hoodie with a relaxed, modern streetwear drop-shoulder fit.',
  ...
  ProductModel(
    ...
    description: 'Slim-fit formal wool trousers tailored with precise pleating for executive comfort.',
  ...
  ProductModel(
    ...
    description: 'Sleek everyday shoulder bag made from full-grain leather with brass hardware.',
  ...
  ProductModel(
    ...
    description: 'Sharp silhouette blazer featuring subtle shoulder pads and custom tortoiseshell buttons.',
  ...
  ProductModel(
    ...
    description: 'Ultra-soft knitted crewneck sweater designed for lightweight warmth during cold seasons.',
  ...
  ProductModel(
    ...
    category: 'Streetwear',
    price: 280,
    image: 'https://images.unsplash.com/photo-1543076447-215ad9ba6923?q=80&w=1000&auto=format&fit=crop',
    description: 'Vintage washed denim jacket featuring reinforced stitching and custom metal buttons.',
  ...
  ProductModel(
    ...
    description: 'High-waisted knife-pleated midi skirt with a subtle satin shimmer effect.',
  ...
  ProductModel(
    ...
    description: 'Handcrafted leather boots with elastic side panels and durable rubber soles.',
  ...
  ProductModel(
    ...
    description: 'Breathable European linen shirt perfect for smart-casual summer layering.',
